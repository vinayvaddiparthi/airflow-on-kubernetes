    ...
    DecryptionSpec(
        ...
        whereclause=literal_column("$1:key").in_(
            [
                ...
                "total_nsfs",
                "total_nsfs_last_3_month",
                "outstanding_balance_1_month_ago",
                "ci_score",
                "pi_score",
                "supplier_debt",
                "last_commercial_bureau_pull",
                "previous_newco_default_account",
                "max_dpd_last_12_month",
                "sf_max_dpd_last_12_month",
                "ario_max_dpd_last_12_month",
                "ario_max_dpd_last_6_month",
            ]
        ),
    ),
]
