sobjects = [
    ...
    {"name": "assignment__history"},
    {"name": "quote__history"},
    {"name": "product_summary__history"},
    {"name": "registration__history"},
    {"name": "product__history"},
    {"name": "credit_check__history"},
    {"name": "approval__history"},
    {"name": "footprint__footprint_line_item__history"},
    {"name": "dsfs__docusign_recipient_status__history"},
    {"name": "remuneration__history"},
    {"name": "document__history"},
    {"name": "milestone__history"},
    {"name": "footprint__footprint__history"},
    {"name": "checklist_item__history"},
    {"name": "account_product_eligibility__history"},
    {"name": "store_code__history"},
    {"name": "note__history"},
]
